...
def install_hooks [] { pre-commit install ; pre-commit install --hook-type prepare-commit-msg --hook-type commit-msg }
def remove_hooks [] { pre-commit uninstall ; pre-commit uninstall --hook-type prepare-commit-msg --hook-type commit-msg}
def gsync [] { git fetch upstream ; git rebase upstream/master }
